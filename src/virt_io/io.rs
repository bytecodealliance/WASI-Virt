...
const WASI_IO_EXPORTS: &[&str] = &[
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.blocking-flush",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]input-stream.blocking-read",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]input-stream.blocking-skip",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.blocking-splice",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.blocking-write-and-flush",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.check-write",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[dtor]input-stream",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[dtor]output-stream",
    "wasi:io/error@0.2.0-rc-2023-11-10#[dtor]error",
    "wasi:io/error@0.2.0-rc-2023-11-10#[method]error.to-debug-string",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.flush",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]input-stream.read",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]input-stream.skip",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.splice",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]input-stream.subscribe",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.subscribe",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.write",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.write-zeroes",
    "wasi:io/streams@0.2.0-rc-2023-11-10#[method]output-stream.blocking-write-zeroes-and-flush",
    "wasi:io/poll@0.2.0-rc-2023-11-10#[method]pollable.ready",
    "wasi:io/poll@0.2.0-rc-2023-11-10#[method]pollable.block",
    "wasi:io/poll@0.2.0-rc-2023-11-10#[dtor]pollable",
    "wasi:io/poll@0.2.0-rc-2023-11-10#poll",
];
